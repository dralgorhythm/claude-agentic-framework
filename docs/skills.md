...
- **Generated by tailor** — stack- and policy-specific skills manufactured into an adopter's own repo from their `tech-strategy.md`; never listed here at all — stack packs (typescript, python, go) under `.claude/templates/stack-packs/`.
