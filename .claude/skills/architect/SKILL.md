...
Follow the `designing-systems` and `writing-adrs` skills for methodology (C4 diagrams, trade-off analysis, ADR format). This entry point adds the architect-role workflow and standards-definition mandate below.
